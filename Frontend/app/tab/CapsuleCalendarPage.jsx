...
const CapsuleCalendarPage = () => {
    ...
    const [selectedCapsules, setSelectedCapsules] = useState([]); // Changed from tooltip to selectedCapsules
    ...
    // Create marked dates with count indicator for multiple capsules
    ...
    const handleDateSelect = (day) => {
        ...
        // Find ALL capsules for the selected date
        const capsulesForDate = capsules.filter((item) => 
            moment(item.UnlockDate).format('YYYY-MM-DD') === day.dateString
        );
            ...
            <View style={styles.infoContainer}>
                {selectedCapsules.length > 0 ? (
                    <>
                        ...
                        <View style={styles.capsulesContainer} showsVerticalScrollIndicator={false}>
                    ...
                    <>
                        ...
                        <TouchableOpacity 
                            style={styles.button} 
                            onPress={() => { router.push('/tab/CameraScreen'); }}
                        >
